                        ...
                        <div class="row">
                                ...
                                <div class="product-gallery product-gallery-vertical">
                                    <div class="row">
                                        <figure class="product-main-image">
                                            <img id="product-zoom" 	src="<c:url value='/template/web/assets/images/demos/demo-20/banners/banner-1.jpg'/>" data-zoom-image="/template/web/assets/images/products/single/centered/1-big.jpg" alt="product image">
                                        ...
                                        <div id="product-zoom-gallery" class="product-image-gallery">
                                            <a class="product-gallery-item active" href="#" data-image="assets/images/products/single/centered/1.jpg" data-zoom-image="assets/images/products/single/centered/1-big.jpg">
                                                <img src="<c:url value='/template/web/assets/images/demos/demo-20/banners/banner-1.jpg'/>" alt="product side">
                                            </a>
                                            ...
                                            <a class="product-gallery-item" href="#" data-image="assets/images/products/single/centered/2.jpg" data-zoom-image="assets/images/products/single/centered/2-big.jpg">
                                                <img src="<c:url value='/template/web/assets/images/demos/demo-20/banners/banner-1.jpg'/>" alt="product cross">
                                            </a>
                                            ...
                                            <a class="product-gallery-item" href="#" data-image="assets/images/products/single/centered/3.jpg" data-zoom-image="assets/images/products/single/centered/3-big.jpg">
                                                <img src="<c:url value='/template/web/assets/images/demos/demo-20/banners/banner-1.jpg'/>" alt="product with model">
                                            </a>
                                            ...
                                            <a class="product-gallery-item" href="#" data-image="assets/images/products/single/centered/4.jpg" data-zoom-image="assets/images/products/single/centered/4-big.jpg">
                                                <img src="<c:url value='/template/web/assets/images/demos/demo-20/banners/banner-1.jpg'/>" alt="product back">
                                            </a>
                            ...
                            <div class="col-md-6">
                                <div class="product-details product-details-centered">
                                    <h1 class="product-title">${bookId.name}</h1><!-- End .product-title -->
                                    ...
                                    <div class="product-details-action">
                                        <div class="details-action-col">
                                            ...
                                            <a  class="btn-product btn-cart" onclick="addCart(${bookId.id})"><span>add to cart</span></a>
